...
public class FormPerbaikan extends DialogFragment {
    Spinner sp_mesin;
    Spinner sp_customer;
    EditText txt_no_mc, txt_no_diecut, txt_tgl_perbaikan, txt_keterangan;
    Button btn_tgl_perbaikan, btn_simpan;
    ...
    public FormPerbaikan(String _key_, String _txt_no_mc_, String _txt_no_diecut_, String _sp_customer_, String _txt_tgl_perbaikan_, String _sp_mesin_, String _txt_keterangan_, String pilih, Context context) {
        this._key_ = _key_;
        this._txt_no_mc_ = _txt_no_mc_;
        this._txt_no_diecut_ = _txt_no_diecut_;
        this._sp_customer_ = _sp_customer_;
        this._txt_tgl_perbaikan_ = _txt_tgl_perbaikan_;
        this._sp_mesin_ = _sp_mesin_;
        this._txt_keterangan_ = _txt_keterangan_;
        this.pilih = pilih;
        this.context = context;
    }

    public FormPerbaikan(String pilih, Context context) {
        this.pilih = pilih;
        this.context = context;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.form_perbaikan, null);
        ...
        txt_tgl_perbaikan = v.findViewById(R.id.txt_tgl_perbaikan);
        txt_keterangan = v.findViewById(R.id.txt_keterangan);


        btn_simpan = v.findViewById(R.id.btn_simpan);
        btn_tgl_perbaikan = v.findViewById(R.id.btn_tgl_perbaikan);
        ...
        if (pilih.equals("ubah")) {
            ...
            txt_tgl_perbaikan.setText(_txt_tgl_perbaikan_);
            txt_keterangan.setText(_txt_keterangan_);
        }

        btn_tgl_perbaikan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(context, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        ...
                        txt_tgl_perbaikan.setText(simpleDateFormat.format(calendar.getTime()));
        ...
        btn_simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                String _txt_tgl_perbaikan = txt_tgl_perbaikan.getText().toString();
                String _sp_mesin = sp_mesin.getSelectedItem().toString();
                String _sp_customer = sp_customer.getSelectedItem().toString();
                String _txt_keterangan = txt_keterangan.getText().toString();
                ...
                if (_txt_no_mc.isEmpty()) {
                ...
                } else if (_txt_tgl_perbaikan.isEmpty()) {
                    txt_tgl_perbaikan.setError("Data tidak boleh kosong");
                    txt_tgl_perbaikan.requestFocus();
                } else if (_txt_keterangan.isEmpty()) {
                    txt_keterangan.setError("Data tidak boleh kosong");
                    ...
                    if (pilih.equals("tambah")) {
                        database.child("perbaikan").child(_txt_no_diecut).setValue(new dataPerbaikan(
                                _txt_no_mc,
                                _txt_no_diecut,
                                _sp_customer,
                                _txt_tgl_perbaikan,
                        ...
                        database.child("perbaikan").child(_key_).setValue(new dataPerbaikan(
                                _txt_no_mc,
                                _txt_no_diecut,
                                _sp_customer,
                                _txt_tgl_perbaikan,
