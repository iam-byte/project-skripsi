...
public class FormPenarikan extends DialogFragment {
    Spinner sp_mesin;
    Spinner sp_customer;
    EditText txt_no_mc, txt_no_diecut, txt_tgl_masuk, txt_nama, txt_nik;
    Button btn_tgl_masuk, btn_simpan;
    ...
    public FormPenarikan(String _key_, String _txt_no_mc_, String _txt_no_diecut_, String _txt_tgl_masuk_, String _txt_nama_, String _txt_nik_, String _sp_mesin_, String _sp_customer_, String pilih, Context context) {
        this._key_ = _key_;
        this._txt_no_mc_ = _txt_no_mc_;
        this._txt_no_diecut_ = _txt_no_diecut_;
        this._txt_tgl_masuk_ = _txt_tgl_masuk_;
        this._txt_nama_ = _txt_nama_;
    ...
    public FormPenarikan(String pilih, Context context) {
        this.pilih = pilih;
        this.context = context;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.form_penarikan, null);
        ...
        if (pilih.equals("ubah")) {
            ...
            txt_tgl_masuk.setText(_txt_tgl_masuk_);
            txt_nama.setText(_txt_nama_);
            txt_nik.setText(_txt_nik_);
        }

        btn_tgl_masuk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(context, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        ...
                        txt_tgl_masuk.setText(simpleDateFormat.format(calendar.getTime()));
        ...
        btn_simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                String _txt_tgl_masuk = txt_tgl_masuk.getText().toString();
                String _txt_nama = txt_nama.getText().toString();
                ...
                if (_txt_no_mc.isEmpty()) {
                ...
                } else if (_txt_tgl_masuk.isEmpty()) {
                    txt_tgl_masuk.setError("Data tidak boleh kosong");
                    txt_tgl_masuk.requestFocus();
                } else if (_txt_nama.isEmpty()) {
                    txt_nama.setError("Data tidak boleh kosong");
                    ...
                    if (pilih.equals("tambah")) {
                        database.child("penarikan").child(_txt_no_diecut).setValue(new dataPenarikan(
                                _txt_no_mc,
                                _txt_no_diecut,
                                _sp_customer,
                                _txt_tgl_masuk,
                        ...
                        database.child("penarikan").child(_key_).setValue(new dataPenarikan(
                                _txt_no_mc,
                                _txt_no_diecut,
                                _sp_customer,
                                _txt_tgl_masuk,
